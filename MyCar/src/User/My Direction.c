...
//uint16_t  ADC_max[4]={0},ADC_min[4]={10000};
extern uint16_t  ADC_max[4]={0},ADC_min[4]={10000};
...
{    
     ...
     /*差比和---水平*/
     Direct_error[0]=(float)(left_value[0]-right_value[0])/(left_value[0]+right_value[0]);
     //Direct_error[0]=(Direct_error[0]>1?1:Direct_error[0]);
     //Direct_error[0]=(Direct_error[0]<-1?-1:Direct_error[0]);
     /*差比和---竖直*/
     Direct_error[1]=(float)(left_value[1]-right_value[1])/(left_value[1]+right_value[1]);
